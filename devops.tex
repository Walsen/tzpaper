...
\bibitem{IEEEhowto:loukides}
M.~Loukides, \emph{What is DevOps?}, 1st~ed. \hskip 1em plus
  0.5em minus 0.4em\relax 1005 Gravenstein Highway North: O'Reilly Media, 2012.

\bibitem{IEEEhowto:agile}
\url{http://en.wikipedia.org/wiki/Agile_software_development}

\bibitem{IEEEhowto:buildingdevops}
M.~Walls, \emph{Building a DevOps Culture}, 1st.~ed. \hskip 1em plus
  0.5em minus 0.4em\relax 1005 Gravenstein Highway North: O'Reilly Media, 2013.

\bibitem{IEEEhowto:whatisdevopsanyway}
S.~Nelson-Smith, \emph{What Is This Devops Thing, Anyway?}, Web:
\url{http://www.jedi.be/blog/2010/02/12/what-is-this-devops-thing-anyway/}

\bibitem{IEEEhowto:phoenixproject}
G.~Kim, K.~Behr and G.~Spafford, \emph{The Phoenix Project: A Novel About  IT, DevOps, and Helping Your Business Win}, 1st~ed.\hskip 1em plus
  0.5em minus 0.4em\relax Portland, Oregon: IT Revolution Press, 2013.

\bibitem{IEEEhowto:booch}
G.~Booch, \emph{Object Solutions: Managing the Object-Oriented Project}, 3th~ed.\hskip 1em plus
  0.5em minus 0.4em\relax Addison-Wesley Professional, 2007.

\bibitem{IEEEhowto:Wikipedia}
\url{http://en.wikipedia.org/wiki/Continuous_delivery}
  
\bibitem{IEEEhowto:ries}
E.~Ries, \emph{Why Continuous Deployment?}, Web: \hskip 1em plus
  0.5em minus 0.4em\relax Startup Lessons Learned.
  \url{http://www.startuplessonslearned.com/2009/06/why-continuous-deployment.html}
  
\bibitem{IEEEhowto:12factor}
\url{http://12factor.net/}

\bibitem{IEEEhowto:lean}
\url{http://theleanstartup.com/}

\bibitem{IEEEhowto:kanban}
\url{http://en.wikipedia.org/wiki/Kanban_(development)}

\bibitem{IEEEhowto:brunton-spall}
\url{http://www.brunton-spall.co.uk/post/2012/03/13/what-is-devops-not/}
